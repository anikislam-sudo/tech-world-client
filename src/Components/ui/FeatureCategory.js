...
const FeatureCategory = () => {
    ...
    return (
        ...
        <div
          ...
          className="border border-gray-300 max-w-[110px] w-full h-24 p-2 hover:shadow-lg hover:text-emerald-300 shadow-gray-400 flex flex-col justify-center items-center rounded-md transition-all duration-200 cursor-pointer mx-auto"
        >
          <BsCpuFill size={40} />
        ...
        <div
          ...
          className="border border-gray-300 max-w-[110px] w-full h-24 p-2 hover:shadow-lg hover:hover:text-emerald-300 shadow-gray-400 flex flex-col justify-center items-center rounded-md transition-all duration-200 cursor-pointer mx-auto"
        >
